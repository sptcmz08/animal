    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-[1fr_250px] lg:grid-cols-[1fr_300px] gap-6 md:gap-8 items-stretch">
            ...
            $defaultServices = [
                ...
                3 => ['title' => 'วัสดุคุณภาพสูง', 'desc' => 'คัดสรรวัสดุคุณภาพสูง ปลอดภัย ทนทาน เหมาะสำหรับสัตว์เลี้ยงทุกชนิด'],
                4 => ['title' => 'จัดส่งและติดตั้งทั่วประเทศ', 'desc' => 'บริการจัดส่งและติดตั้งถึงบ้านทั่วประเทศ พร้อมรับประกันสินค้า'],
            ];
            ?>

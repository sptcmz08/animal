<?php $fs = getAllSettings(); $fg = function($k,$d='') use ($fs) { return $fs[$k] ?? $d; }; ?>
<!-- FOOTER -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
            ...
            <div>
                <a href="<?= BASE_URL ?>" class="flex flex-col mb-4">
                    ...
                    <span class="text-[10px] tracking-[0.2em] uppercase text-elite-400 mt-0.5">Custom Pet Furniture</span>
                </a>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?= $lu ?>" target="_blank"
                        ...
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M24 10.304c0-5.369-5.383-9.738-12-9.738-6.616 0-12 4.369-12 9.738 0 4.814 4.269 8.846 10.036 9.608.391.084.922.258 1.057.592.121.303.079.778.039 1.085l-.171 1.027c-.053.303-.242 1.186 1.039.647 1.281-.54 6.911-4.069 9.428-6.967C23.309 14.254 24 12.382 24 10.304z"/></svg>
                    </a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    <li><a href="<?= BASE_URL ?>" class="text-sm text-white/40 hover:text-elite-400 transition-colors">หน้าแรก</a></li>
                    <li><a href="<?= BASE_URL ?>products.php" class="text-sm text-white/40 hover:text-elite-400 transition-colors">สินค้าทั้งหมด</a></li>
                    <li><a href="<?= BASE_URL ?>blog.php" class="text-sm text-white/40 hover:text-elite-400 transition-colors">บทความ</a></li>
                    <li><a href="<?= BASE_URL ?>contact.php" class="text-sm text-white/40 hover:text-elite-400 transition-colors">ติดต่อเรา</a></li>
                </ul>
            </div>
